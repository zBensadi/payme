...
class SecuredClientVisibilityRepository implements ClientVisibilityRepository, RepositoryChangePublisher {
  ...
  AppFailure _unauthorized() {
    return const AuthFailure('You do not have permission to manage client visibility.');
  }
